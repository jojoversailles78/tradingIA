...
AGENT_FILE = "C:/tradingIA/agent_state.json"
...
@app.get("/")
async def root():
    return FileResponse("C:/tradingIA/html/index.html")

@app.get("/agent")
async def agent_page():
    return FileResponse("C:/tradingIA/html/agent.html")
'''

with open('C:/tradingIA/backend/app/main.py', 'w', encoding='utf-8') as f:
    f.write(content)
print('OK - main.py avec planificateur thread ecrit avec succes')